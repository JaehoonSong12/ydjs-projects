...
// class UIView {
//     // needs to have a relationship (composition) with UI Container.
//     // Must have a container so it displays UI component based on tree data structure.
// }


// abstract class UIComponent {
//     // need to be base of all UI elements
//     // should define basic LWJGL rendering 
//     // methods so children have  rendering abstraction
// }

// class UIContainer extends UIComponent {
//     // needs to have a relationship (composition) with UI component.
//     // Root of UI view should be defined with tree data structure of UIComponent(s)
// }
