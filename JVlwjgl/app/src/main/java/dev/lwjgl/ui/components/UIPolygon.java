...
public class UIPolygon  extends UIComponent {
    ...
    public UIPolygon(int n, double xCenter, double yCenter, double radius, double rotationalAngle) { // x,y are centers
//        double side = Math.sqrt(2) * radius;
        this(n, xCenter, yCenter, radius, rotationalAngle, Colors.DARK_RED);
    }

    public UIPolygon(int n, double xCenter, double yCenter, double radius, double rotationalAngle, float[] color) {
        super(
